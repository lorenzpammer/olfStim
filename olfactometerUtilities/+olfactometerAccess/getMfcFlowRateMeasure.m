function [mfcCapacity, units] = getTargetFlowRate(debug, olfactometerH, slave, MfcID)
% [mfcCapacity, units] = olfactometerAccess.getTargetFlowRate(debug, olfactometerH, slave, MfcID)
